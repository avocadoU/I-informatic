...
public class WindowWordControlWorkThreeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        SpecialMethodsClass.switchWindow(nextWindow, "/Fxml/WindowWord/WindowWordFour.fxml");

        SpecialMethodsClass.switchWindow(lastWindow, "/Fxml/WindowWord/WindowWordThree.fxml");
